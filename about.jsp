			...
			<div class="card-body">
				<div class="row text-center pt-4">
					<div class="col-lg-4 pb-4">
						<img alt="ธีรณัฐ มหัทธโนบล" class="rounded-circle shadow" width="140" height="140" src="assets/img/Amal.jpg" />
						<h5 class="pt-4 mb-3">ผู้พัฒนาระบบ</h5>
						<h2>อามัล หะยีแยนา</h2>
						<p class="text-muted">รหัสประจำตัวนักศึกษา: 6139010029</p>
						<p class="pt-3"><a class="btn btn-primary" href="https://www.facebook.com/Amal.yaring" role="button"><i class="fab fa-facebook-square"></i>&nbsp; @Amal.yaring</a></p>
                                        </div>
					<div class="col-lg-4 pb-4">
						<img alt="ธีระ บินกาเซ็ม" class="rounded-circle shadow" width="140" height="140" src="assets/img/teera.jpg" />
