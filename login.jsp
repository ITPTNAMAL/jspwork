...
<body class="bg-secondary text-white">
    <form  action="login.jsp" method="POST" class="form-signin">
        <div class="text-center mb-4">
            ...
            <h1 class="h3 text-white font-weight-normal">ยินดีต้อนรับ</h1>
            <p class=" text-white">โปรดลงชื่อเข้าใช้ เพื่อดำเนินการต่อ</p>
        </div>
		<%
        ...
        <button class="btn btn-lg btn-dark btn-block" type="submit">ลงชื่อเข้าใช้</button>
		<p class="mt-2 text-white small text-center">ไม่มีบัญชีผู้ใช้? <a class="text-dark " href="register.jsp">สมัครผู้ใช้ใหม่</a></p>
