...
<body class="bg-secondary">
	...
	<main role="main" class="container">
		<div class="d-flex align-items-center p-3 my-3 text-white-50 bg-dark rounded shadow-sm pb-2">
	...
	<p class="mt-5 small text-muted text-center">&copy; 2019 Likecyber</p>
